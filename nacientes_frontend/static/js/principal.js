...
function iniciar() {
    ...
    const agregarNacientesAlMapa = (json) => {
        // console.log(json)

        // Se obtienen los datos en GeoJSON
        nacientes = L.geoJSON(json, {}).addTo(mapa);

        // Se agrgan los datos GeoJSON al mapa
        control_capas.addOverlay(nacientes, "Nacientes");      
    }

    // Llamado a fetchGetRequest()
    fetchGetRequest('/api/v1/nacientes', agregarNacientesAlMapa)
}